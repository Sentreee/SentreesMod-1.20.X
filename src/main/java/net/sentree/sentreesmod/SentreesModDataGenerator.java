...
import net.sentree.sentreesmod.datagen.*;
import net.sentree.sentreesmod.world.ModConfiguredFeatures;
...
public class SentreesModDataGenerator implements DataGeneratorEntrypoint {
	@Override
