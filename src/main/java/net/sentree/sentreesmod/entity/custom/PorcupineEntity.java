package net.sentree.sentreesmod.entity.custom;
...
import net.sentree.sentreesmod.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.25D, Ingredient.ofItems(ModItems.CUCUMBER), false));
