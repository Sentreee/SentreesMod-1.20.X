package net.sentree.sentreesmod.world.tree.custom;
...
public class SaltyTrunkPlacer extends TrunkPlacer {
    public static final Codec<SaltyTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, SaltyTrunkPlacer::new));

    public SaltyTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerTypes.SALTY_TRUNK_PLACER;
    }
...
//
        ...
        return ImmutableList.of(new FoliagePlacer.TreeNode(startPos.up(height_), 0, true));
    }
}
