...
public class CookingPotScreenHandler extends ScreenHandler {
    ...
    public CookingPotScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.addSlot(new Slot(inventory, 2, 17, 11));
        this.addSlot(new Slot(inventory, 3, 35, 11));
        this.addSlot(new Slot(inventory, 4, 53, 11));
        this.addSlot(new Slot(inventory, 5, 35, 29));
